...
function ensureStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `.vcp-uiux-language-row{display:flex;align-items:center;gap:8px;padding:16px 0;border-bottom:1px solid var(--dsw-alias-border-l2,rgba(0,0,0,.1))}.vcp-uiux-language-row-text{flex:1;min-width:0;display:flex;flex-direction:column;gap:4px;padding-right:48px}.vcp-uiux-language-row-title{font-size:14px;font-weight:400;line-height:22px;color:var(--dsw-alias-label-primary,#0f1115)}.vcp-uiux-language-row-description{font-size:12px;line-height:18px;color:var(--dsw-alias-label-tertiary,#81858c)}.vcp-uiux-language-row-selector{display:inline-flex;align-items:center;gap:12px;height:36px;padding:0 14px;border:0;border-radius:18px;background:var(--dsw-alias-bg-module-platform,rgb(245,246,247));font:inherit;font-size:14px;line-height:22px;color:var(--dsw-alias-label-primary,#0f1115);cursor:pointer}.vcp-uiux-language-row-selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,rgba(38,49,72,.06))}.vcp-uiux-language-row-selector:disabled{cursor:default;opacity:.5}.vcp-uiux-language-row-chevron{display:block;flex:none;width:14px;height:14px}`;
