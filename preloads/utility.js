...
function createCatalog(ops) {
    return {
        ...
        saveChatHistory: query((agentId, topicId, history, options) => ops.invoke('save-chat-history', agentId, topicId, history, options)),
        ...
        saveGroupChatHistory: query((groupId, topicId, history, options) => ops.invoke('save-group-chat-history', groupId, topicId, history, options)),
